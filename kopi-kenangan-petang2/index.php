...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" 
        ...
        data-client-key="Mid-client-YYeWPxzVuQXn7Idc"></script>
  ...
  <body>
      ...
      <!-- Shopping Cart start -->
       <div class="shopping-cart">
        ...
        <div class="form-container" x-show="$store.cart.items.length">
          ...
          -->
          <form action="saverec.php" method="POST" id="checkoutForm">
    ...
    <section class="hero" id="home">
         <main class="content">
            <h1>Mari Nikmati Secangkir <span>Kopi</h1>
    ...
    <section id="about" class="about">
        ...
        <div class="content">
            ...
            <p>Dengan pengalaman dan pengetahuan yang luas, kami berkomitmen untuk menyajikan kopi yang lezat dan memuaskan bagi Anda. </p>
            <p>Kami tidak hanya menyajikan kopi, kami menyajikan pengalaman yang autentik dan memuaskan, dengan kualitas yang tak terkalahkan dan rasa yang tak terlupakan.</p>
        </div>
    </div>
    </section>
    <!-- About Section end -->
    ...
    <!-- Contact Section start -->
     <section id="contact" class="contact">
       ...
       <div class="row">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253840.4913165482!2d106.66470409102905!3d-6.229720928612766!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta%2C%20Daerah%20Khusus%20Ibukota%20Jakarta!5e0!3m2!1sid!2sid!4v1749187568029!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="map"></iframe>
    ...
    <!-- Footer start -->
     <footer>
      ...
      <div class="credit">
        <p>Created by <a href="">namiraassalwa</
          a>. | &copy; 2025.</p>
      </div>
     </footer>
    <!-- Footer end -->
     ...
     <div class="modal" id="item-detail-modal">
      <div class="modal-container">
        ...
        <div class="modal-content">
          ...
          <div class="product-content">
            <h3>Product 1</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium at a itaque architecto deserunt ipsa earum, excepturi cum temporibus, esse aperiam quas sapiente similique dignissimos?</p>
            <div class="product-stars">
